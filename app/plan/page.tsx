...
export const metadata: Metadata = {
  title: 'Your Free Transformation Call — What You Walk Away With | Fit Body Boot Camp Matthews',
  description:
    'A personal transformation roadmap, a free InBody Success Scan, and a straight answer. The 3 missing pieces behind every lasting transformation — and how we built a gym around them.',
...
const CTA = 'Apply For Your Free Transformation Assessment →';

/**
 * Page 2 — the full sales letter. Everything from the old single page EXCEPT
 * the video and the application form, in spec order. Every CTA → /apply.
 */
  ...
  return (
    <>
      ...
      <main className="pb-10">
        ...
        <StickyCta href="/apply" label="Apply For My Free Call →" revealAfter={0} />
      </main>
      <FunnelFooter />
    </>
  );
